...
/**
 * Created by Abhishek on 21/10/20.
 */
public class BottomDialog
{
    ...
    private Dialog initBottomDialog(final Builder builder)
    {
        ...
        vMainLayout = view.findViewById(R.id.linearLayout);
        ...
        {
            vMainLayout.setBackgroundColor(Color.parseColor("#ffffff"));
        }
        ...
        else
        {
            ...
            tvGallery.setTextColor(Color.parseColor("#000000"));
            tvCamera.setTextColor(Color.parseColor("#000000"));
        }
