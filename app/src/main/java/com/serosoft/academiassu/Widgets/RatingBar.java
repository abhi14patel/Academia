...
public class RatingBar extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mFillDrawable = context.getDrawable(R.drawable.ic_active_star);
                mEmptyDrawable = context.getDrawable(R.drawable.ic_inactive_star);
            } else {
                mFillDrawable = context.getResources().getDrawable(R.drawable.ic_active_star);
                mEmptyDrawable = context.getResources().getDrawable(R.drawable.ic_inactive_star);
            }
        } else {
