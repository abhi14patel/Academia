...
public class MedConditionTypeAdapter extends ArrayAdapter<DocumentType_Dto> {

    private Context mContext;
    private ArrayList<DocumentType_Dto> documentTypeList;

    public MedConditionTypeAdapter(Context mContext, ArrayList<DocumentType_Dto> documentTypeList){
