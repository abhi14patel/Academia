...
public class HostelLeaveRequestDetailsActivity extends BaseActivity implements AsyncTaskCompleteListener, View.OnClickListener{

    private Context mContext;
    private Toolbar toolbar;
    private RelativeLayout rlRequesterDetails;
    private TextView tvCount,tvRequestStatus,tvRequesterName,tvHostelName,tvBuildingName,tvRoomNumber,tvEnteredBy,tvRequestAssignedTo,tvRequestDate,tvRequestReason,tvFromDateTime,tvToDateTime,tvComment;
    ...
    private final String TAG = HostelLeaveRequestDetailsActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.leave_request_details_hostel_activity);
        ProjectUtils.showLog(TAG,"onCreate start");

        mContext = HostelLeaveRequestDetailsActivity.this;
    ...
    public void onClick(View v) {
        ...
        switch (id){
            ...
            case R.id.llExecution:
                ...
                intent2.putExtra(Consts.LEAVE_TYPE,"HOSTEL_LEAVE");
        ...
        switch (callFor)
        {
            case KEYS.SWITCH_REQUESTER_DETAILS:
                try {
                    ...
                    tvBuildingName.setText(ProjectUtils.getCorrectedString(building));
                    ...
                    JSONObject jsonObject1 = jsonObject.optJSONObject("hostel");
                    String hostel = jsonObject1.optString("value");
                    tvHostelName.setText(ProjectUtils.getCorrectedString(hostel));

                    JSONObject jsonObject2 = jsonObject.optJSONObject("room");
                    String room = jsonObject2.optString("value");
                    tvRoomNumber.setText(ProjectUtils.getCorrectedString(room));

                    if (ConnectionDetector.isConnectingToInternet(mContext)) {

                        new OptimizedServerCallAsyncTask(this,
                                this, KEYS.SWITCH_REQUESTER_HOSTEL_BASIC_DETAILS).execute(requestId);
                    } else {
                        Toast.makeText(this, KEYS.NET_ERROR_MESSAGE, Toast.LENGTH_SHORT).show();
                    }
            ...
            case KEYS.SWITCH_WITHDRAW_REQUEST:
                ...
                try {
                    ...
                    if(jsonObject.has("message")){
                        ...
                        showAlertDialog2(HostelLeaveRequestDetailsActivity.this, getString(R.string.oops), getString(R.string.something_went_wrong));
                    }
