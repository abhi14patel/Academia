...
public class EventUpcomingFragment extends Fragment {
    ...
    private final String TAG = EventUpcomingFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle != null){
            ...
            eventList = (ArrayList<Events_Dto>) bundle.getSerializable("Upcoming");
        ...
        if(eventList != null && eventList.size() > 0) {
            ...
            Collections.sort(eventList, Events_Dto.sortMostRecently);
