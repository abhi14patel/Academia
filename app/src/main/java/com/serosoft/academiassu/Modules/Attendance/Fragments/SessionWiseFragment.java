...
public class SessionWiseFragment extends Fragment implements AsyncTaskCompleteListener {
    ...
    private final String TAG = SessionWiseFragment.class.getSimpleName();
    ...
    private void populateContents() {
        ...
        if (ConnectionDetector.isConnectingToInternet(mContext))
        {
            ...
            new OptimizedServerCallAsyncTask(mContext, this,
                    KEYS.SWITCH_ATTENDANCE_SUMMARY_MULTIPLE_SESSION).execute(periodId,sectionId,startDate,endDate);
            ...
            case KEYS.SWITCH_ATTENDANCE_SUMMARY_MULTIPLE_SESSION:
                ...
                try {
                    ...
                    if (arr != null && arr.length() > 0)
                    {
                        ...
                        multipleAttendanceTypeAdapter = new MultipleAttendanceTypeAdapter(mContext,attendanceTypeList,KEYS.MULTIPLE_SESSION);
                        ...
                        multipleAttendanceTypeAdapter.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                intent.putExtra("attendanceType", KEYS.MULTIPLE_SESSION);
