...
public class EventPastFragment extends Fragment {
    ...
    private final String TAG = EventPastFragment.class.getSimpleName();

    public static EventPastFragment newInstance(ArrayList<Events_Dto> eventList) {
        EventPastFragment fragment = new EventPastFragment();
        Bundle args = new Bundle();
        args.putSerializable(Consts.EVENT_LIST, eventList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle != null){
            ...
            eventList = (ArrayList<Events_Dto>) bundle.getSerializable("Past");
        ...
        if(eventList != null && eventList.size() > 0){
            ...
            Collections.sort(eventList, Events_Dto.sortMostPassed);
