...
public class AttendanceTypeAdapter extends RecyclerView.Adapter<AttendanceTypeAdapter.MyViewHolder> {
    ...
    public AttendanceTypeAdapter(Context context, ArrayList<AttendanceType_Dto> attendanceTypeList) {
